...
import { OMNIDEF } from './aRTLAccountCreationEnglish_def.js';
import tmpl from './aRTLAccountCreationEnglish.html';
import tmpl_nds from './aRTLAccountCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLAccountCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
