...
import { OMNIDEF } from './aRTLLeadCreationEnglish_def.js';
import tmpl from './aRTLLeadCreationEnglish.html';
import tmpl_nds from './aRTLLeadCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLLeadCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
