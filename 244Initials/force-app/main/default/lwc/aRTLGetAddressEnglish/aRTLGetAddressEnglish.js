...
import { OMNIDEF } from './aRTLGetAddressEnglish_def.js';
import tmpl from './aRTLGetAddressEnglish.html';
import tmpl_nds from './aRTLGetAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLGetAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
