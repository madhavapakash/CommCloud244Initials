...
import { OMNIDEF } from './aRTLLeadConversionEnglish_def.js';
import tmpl from './aRTLLeadConversionEnglish.html';
import tmpl_nds from './aRTLLeadConversionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLLeadConversionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
