...
import { OMNIDEF } from './aRTLCalloutEventEnglish_def.js';
import tmpl from './aRTLCalloutEventEnglish.html';
import tmpl_nds from './aRTLCalloutEventEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLCalloutEventEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
