...
import { OMNIDEF } from './aRTLClickToCallEnglish_def.js';
import tmpl from './aRTLClickToCallEnglish.html';
import tmpl_nds from './aRTLClickToCallEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLClickToCallEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
